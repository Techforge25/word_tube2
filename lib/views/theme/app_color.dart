...
abstract class AppColor {
  ...
  static Color checkMarkColor = Colors.blue;
  static Color borderColor5 = Color(0xFFDEE2E7);
  static Color emailColor = Color(0xFF939393);
  static Color liveAuctionColor = Color(0xFF2DE000);
  static Color tabBarBackgroundColor = Color(0xFFD8C2AC);
  ...
  //static const lightTextColor1 =  Color(0xFF1F2029);
  ...
  //static const lightBorderColor = Color(0x88DCDCDC);
  static const lightBorderColor = Color(0xFFE8ECF4);
  static const Color lightDividerColor = Color(0xFFE8ECF4);
  static const Color red = Colors.red;
  //static Color? lightDividerColor = Colors.grey[300];
  ...
  //static const darkTextColor1 =  Color(0xFFFDFEFE);
  ...
  //static const darkBorderColor = Color(0x60FFFFFF);
  static const darkBorderColor = Color(0xFFCAC4D0);
  //static Color? darkDividerColor = Colors.white.withOpacity(0.3);
  static const darkDividerColor = Color(0xFFE6E0E9);

  static const barcolor2 = Color(0xFFFFC700);
  static const smallcard = Color(0xFFD8C2AC);
  // static const fontColor = Color(0xFF6B4E45);
  static const fontColor2 = Color.fromARGB(255, 156, 123, 113);

  static const lightgreen = Color(0xFF24FF00);
}
